...
public class Destinations extends JFrame implements Runnable {
    ...
    public void run(){
        ...
        String[] text = new String[]{"JW Marriott Hotel", "Mandarin Oriental Hotel ", "Four Season Hotel", "Raddisson Blue Hotel", "Classsio Hotel",  "The Bay Club Hostel", "Breeze Hotel", "The Taj Hotel", "Happy Moring Hotel", "River View Hotel" };
    ...
    Destinations() {
       ...
       // setLayout(null);
        ...
        caption.setFont(new Font("Tohama", Font.PLAIN, 40));
